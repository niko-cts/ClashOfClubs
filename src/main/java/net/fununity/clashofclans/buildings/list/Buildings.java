...
public enum Buildings implements IBuilding {
    TOWN_HALL(TranslationKeys.COC_BUILDING_GENERAL_TOWN_HALL_NAME, TranslationKeys.COC_BUILDING_GENERAL_TOWN_HALL_DESCRIPTION, new int[]{7, 7}, ResourceTypes.GOLD, Material.OAK_WOOD,
            new BuildingLevelData[]{new BuildingLevelData(1000, 0, 50, 20),
                    new BuildingLevelData(1500, 1, 500, 60)});
